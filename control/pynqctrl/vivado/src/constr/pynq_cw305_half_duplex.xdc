...
#|          |          |        d_rst|handshake_d2c|handshake_c2d|          |        io|          |          |          |
#+----------+----------+-------------+-------------+-------------+----------+----------+----------+----------+----------+
#|    5V  20|   3V3  18|       V7  16|      V13  14|      U13  12|   U12  10|         8|    Y7   6|    U7   4|    GND  2|
#|          |          |         dio3|         dio2|         dio1|     dio0 |          |   clk_c2d|          |          |
#+----------+----------+-------------+-------------+-------------+----------+----------+----------+----------+----------+
...
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { d_rst }]; #IO_L5P_T0_34 Sch=ck_io[0]
