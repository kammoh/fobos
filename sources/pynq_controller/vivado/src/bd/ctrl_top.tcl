...
CONFIG.LOGO_FILE {data/sym_notgate.png} \
  ...
  connect_bd_net -net clk_in1_1 [get_bd_ports clk_in1] [get_bd_pins clk_wiz/clk_in1] [get_bd_pins clk_wiz_adc/clk_in1]
