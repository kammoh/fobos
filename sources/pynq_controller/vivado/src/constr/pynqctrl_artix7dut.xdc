...
set_property -dict {PACKAGE_PIN Y18 IOSTANDARD LVCMOS33} [get_ports dut_rst]
...
set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports {din[1]}]
...
set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS33} [get_ports dut_clk]
...
#set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVCMOS33} [get_ports {adc_d[9]}]
...
set_property -dict {PACKAGE_PIN U5 IOSTANDARD LVCMOS33} [get_ports trigger]
#set_property -dict { PACKAGE_PIN B19   IOSTANDARD LVCMOS33 } [get_ports { ck_io[25] }]; #IO_L2P_T0_AD8P_35 Sch=ad_p[8]

##ChipKit Digital I/O High

set_property -dict {PACKAGE_PIN U5 IOSTANDARD LVCMOS33} [get_ports trigger]
set_property -dict { PACKAGE_PIN V5    IOSTANDARD LVCMOS33 } [get_ports { test }]; #IO_L6N_T0_VREF_13 Sch=ck_io[27]
