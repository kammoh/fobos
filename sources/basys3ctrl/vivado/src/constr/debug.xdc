...
connect_debug_port u_ila_0/probe0 [get_nets [list {top_i/d_timeout_status[0]} {top_i/d_timeout_status[1]} {top_i/d_timeout_status[2]} {top_i/d_timeout_status[3]} {top_i/d_timeout_status[4]} {top_i/d_timeout_status[5]} {top_i/d_timeout_status[6]} {top_i/d_timeout_status[7]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 32 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {top_i/d_timeout[0]} {top_i/d_timeout[1]} {top_i/d_timeout[2]} {top_i/d_timeout[3]} {top_i/d_timeout[4]} {top_i/d_timeout[5]} {top_i/d_timeout[6]} {top_i/d_timeout[7]} {top_i/d_timeout[8]} {top_i/d_timeout[9]} {top_i/d_timeout[10]} {top_i/d_timeout[11]} {top_i/d_timeout[12]} {top_i/d_timeout[13]} {top_i/d_timeout[14]} {top_i/d_timeout[15]} {top_i/d_timeout[16]} {top_i/d_timeout[17]} {top_i/d_timeout[18]} {top_i/d_timeout[19]} {top_i/d_timeout[20]} {top_i/d_timeout[21]} {top_i/d_timeout[22]} {top_i/d_timeout[23]} {top_i/d_timeout[24]} {top_i/d_timeout[25]} {top_i/d_timeout[26]} {top_i/d_timeout[27]} {top_i/d_timeout[28]} {top_i/d_timeout[29]} {top_i/d_timeout[30]} {top_i/d_timeout[31]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 4 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list {dout_IBUF[0]} {dout_IBUF[1]} {dout_IBUF[2]} {dout_IBUF[3]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 4 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list {din_OBUF[0]} {din_OBUF[1]} {din_OBUF[2]} {din_OBUF[3]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe4]
set_property port_width 1 [get_debug_ports u_ila_0/probe4]
connect_debug_port u_ila_0/probe4 [get_nets [list di_ready_IBUF]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe5]
set_property port_width 1 [get_debug_ports u_ila_0/probe5]
connect_debug_port u_ila_0/probe5 [get_nets [list di_valid_OBUF]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe6]
set_property port_width 1 [get_debug_ports u_ila_0/probe6]
connect_debug_port u_ila_0/probe6 [get_nets [list do_ready_OBUF]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe7]
set_property port_width 1 [get_debug_ports u_ila_0/probe7]
connect_debug_port u_ila_0/probe7 [get_nets [list do_valid_IBUF]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe8]
set_property port_width 1 [get_debug_ports u_ila_0/probe8]
connect_debug_port u_ila_0/probe8 [get_nets [list dut_rst_OBUF]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe9]
set_property port_width 1 [get_debug_ports u_ila_0/probe9]
connect_debug_port u_ila_0/probe9 [get_nets [list top_i/dut_controller_0/dut_working]]
create_debug_port u_ila_0 probe
...
connect_debug_port u_ila_0/probe11 [get_nets [list top_i/dut_controller_0/op_done]]
set_property C_CLK_INPUT_FREQ_HZ 300000000 [get_debug_cores dbg_hub]
set_property C_ENABLE_CLK_DIVIDER false [get_debug_cores dbg_hub]
set_property C_USER_SCAN_CHAIN 1 [get_debug_cores dbg_hub]
connect_debug_port dbg_hub/clk [get_nets u_ila_0_clk_slow]
