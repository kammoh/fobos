...
#+----------+----------+-------------+-------------+-------------+----------+----------+----------+----------+----------+
#|   GND  19|   GND  17|           15|     R15   13|      P15  11|     J14 9|    N16  7|         5|    3V3  3|     5V  1|
#|          |          |             |handshake_d2c|handshake_c2d|     d_rst|        io|          |          |          |
#+----------+----------+-------------+-------------+-------------+----------+----------+----------+----------+----------+
...
create_clock -period 50.000 -name sys_clk

#handshake
set_property -dict { PACKAGE_PIN N16    IOSTANDARD LVCMOS33 } [get_ports { io }];
set_property -dict { PACKAGE_PIN J14    IOSTANDARD LVCMOS33 } [get_ports { d_rst }];
