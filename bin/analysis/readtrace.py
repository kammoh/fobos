...
def readTraces(srcFile, dstFile, numTraces):
   print "###### readtraces.py script"	
   print "Reading file. Please wait ..."
   rawTraces = read_raw_traces(srcFile, numTraces)
   print "Saving file. Please wait ..."
   np.save(dstFile, rawTraces)
   print "Done saving."


def main():
   readTraces("rawDataAlingned.npy", "cleanTraces.npy")
