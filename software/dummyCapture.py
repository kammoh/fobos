...
status = ctrl.setDUTClk(DUT_CLk)
print binascii.hexlify(status)
status = ctrl.enableTestMode()
print 'Sending config ...'
status = ctrl.forceReset()
print binascii.hexlify(status)
print 'Sending config ...'
status = ctrl.releaseReset()
print binascii.hexlify(status)
print 'Sending config ...'
...
print binascii.hexlify(status)
print 'Sending config ...'
status = ctrl.setTimeout(TIMEOUT)
print binascii.hexlify(status)
print 'Sending config ...'
status = ctrl.setTriggerWait(TRIG_WAIT)
print binascii.hexlify(status)
status = ctrl.setTriggerLen(TRIG_LENGTH)
print binascii.hexlify(status)
print 'Sending config ...'
status = ctrl.setTriggerMode(TRIG_MODE_FULL)
print binascii.hexlify(status)
print "Reading parameters:"
param = ctrl.getTimeToReset()
